    ...
    if _no_panel_open:
        with st.expander("How to use this page"):
            st.markdown(
                ...
                "and move to the team view — items cannot be added, edited, or deleted once "
                "the session has started\n\n"
                "**Item actions:**\n"
                "- **Edit** — opens the item with pre-populated fields; saving re-runs the "
                "Claude assessment with the updated content\n"
                "- **Delete** — permanently removes the item from the session\n\n"
                "**Column definitions:**\n"
